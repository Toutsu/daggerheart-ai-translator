            ...
            buttons: {
                go: {
                    ...
                    callback: (html) => {
                        ...
                        const glossaryExists = game.journal.some(j => j.name === "AI Glossary");
        ...
        update: {
            ...
            callback: async (html) => {
                ...
                if (text) {
                    ...
                    if (!isGlossaryMode && (text.includes('"name": "AI Glossary"') || text.includes('"name": "AI Glossary"'))) {
