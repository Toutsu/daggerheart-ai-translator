...
export class TranslationAssistantApp extends HandlebarsApplicationMixin(ApplicationV2) {
    ...
    static PARTS = {
        form: {
            template: "modules/daggerheart-ai-translator/templates/translation-dropzone.hbs"
        }
    };
...
export class TranslationConfigApp extends HandlebarsApplicationMixin(ApplicationV2) {
    ...
    static PARTS = {
        form: {
            template: "modules/daggerheart-ai-translator/templates/translation-config.hbs"
        }
    };
...
export class ConfirmationApp extends HandlebarsApplicationMixin(ApplicationV2) {
    ...
    static PARTS = {
        form: {
            template: "modules/daggerheart-ai-translator/templates/confirmation.hbs"
        }
    };
...
export class TranslationResultApp extends HandlebarsApplicationMixin(ApplicationV2) {
    ...
    static PARTS = {
        form: {
            template: "modules/daggerheart-ai-translator/templates/translation-result.hbs"
        }
    };
        ...
        if (text) {
            ...
            if (!text.includes(endMarker)) {
                ...
                if (text.includes("```json") || text.trim().startsWith("{")) {
                    console.warn("DH Translator | Markers missing, but JSON structure detected. Proceeding.");
                } else {
...
export class ConflictResolutionApp extends HandlebarsApplicationMixin(ApplicationV2) {
    ...
    static PARTS = {
        form: {
            template: "modules/daggerheart-ai-translator/templates/translation-conflict.hbs"
        }
    };
...
export class GlossaryUpdateApp extends HandlebarsApplicationMixin(ApplicationV2) {
    ...
    static PARTS = {
        form: {
            template: "modules/daggerheart-ai-translator/templates/translation-glossary.hbs"
        }
    };
...
export class TranslationStatsApp extends HandlebarsApplicationMixin(ApplicationV2) {
    ...
    static PARTS = {
        content: {
            template: "modules/daggerheart-ai-translator/templates/translation-stats.hbs"
        }
    };
...
function checkNextBatch(doc, processingMode = 'translate') {
    setTimeout(() => {
        ...
        if (freshDoc && freshDoc.documentName === "JournalEntry") {
            ...
            console.log(`DH Translator | Check Next Batch (${processingMode}): ${hasMore} (Pages: ${freshDoc.pages.size})`);
